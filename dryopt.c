...
extern void __attribute__((cold, format(__printf__, 1, 2)))
...
extern char const *__attribute__((__const__, returns_nonnull))
...
extern char *__attribute__((nonnull, pure, returns_nonnull))
